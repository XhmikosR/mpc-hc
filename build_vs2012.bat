...
"%MSBUILD%" mpc-hc_vs2012.sln %MSBUILD_SWITCHES%^
...
"%MSBUILD%" mpciconlib_vs2012.sln %MSBUILD_SWITCHES%^
...
FOR %%G IN ("Armenian" "Basque" "Belarusian" "Catalan" "Chinese Simplified"
 ...
 "%MSBUILD%" mpcresources_vs2012.sln %MSBUILD_SWITCHES%^
...
"%InnoSetupPath%" /Q /O"bin12" "distrib\mpc-hc_setup.iss" %MPCHC_INNO_DEF%
IF %ERRORLEVEL% NEQ 0 CALL :SubMsg "ERROR" "Compilation failed!" & EXIT /B
